                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item" href="{{ route('addentree') }} ">Ajout </a>
                                    <a class="dropdown-item" href="{{ route('getallentree') }} ">Liste </a>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item" href="{{ route('addsortie') }} ">Ajout </a>
                                    <a class="dropdown-item" href="{{ route('getallsortie') }} ">Liste </a>
